        ...
        public class MenuPageMasterViewModel : INotifyPropertyChanged
        {
            ...
            public MenuPageMasterViewModel()    
            {
                ...
                if (App.User.IsModerator)
                {
                    ...
                    new MenuPageMenuItem { Id = 2, Title = "Round",Icon = "",IsUnderlined = false,Indentation = new Thickness(5,0,0,0),TextColor = (Color)App.Current.Resources["TextGrayColor"]},
                    new MenuPageMenuItem { Id = 3, Title = "List of Rounds" ,TargetType = typeof(RoundListPage),Icon = "listofteams.png",IsUnderlined = false,Indentation = new Thickness(5,0,0,0),TextColor = (Color)App.Current.Resources["BlackColor"]},
                    new MenuPageMenuItem { Id = 4, Title = "Create a Round" ,TargetType = typeof(CreateRoundPage),Icon = "createteam.png",IsUnderlined = false,Indentation = new Thickness(5,0,0,0),TextColor = (Color)App.Current.Resources["BlackColor"]},
                    new MenuPageMenuItem { Id = 5, Title = "Round Rules" ,TargetType = typeof(ListofRulesPage),Icon = "listofteams.png",IsUnderlined = true,Indentation = new Thickness(5,0,0,0),TextColor = (Color)App.Current.Resources["BlackColor"]},

                    //new MenuPageMenuItem { Id = 6, Title = "Team",Icon = "",IsUnderlined = false,Indentation = new Thickness(5,0,0,0),TextColor = (Color)App.Current.Resources["TextGrayColor"]},
                    ...
                    new MenuPageMenuItem { Id = 9, Title = "Participant" ,Icon = "",IsUnderlined = false,Indentation = new Thickness(5,0,0,0),TextColor = (Color)App.Current.Resources["TextGrayColor"]},
                    ...
                    new MenuPageMenuItem { Id = 12, Title = "Logout" ,Icon = "logout.png",TargetType = typeof(LoginPage),IsUnderlined = false,Indentation = new Thickness(5,0,0,0),TextColor = (Color)App.Current.Resources["BlackColor"]}
                });
                }
                else
                {
                    ...
                    new MenuPageMenuItem { Id = 2, Title = "Round" ,TargetType = typeof(HomePage),Icon = "",IsUnderlined = false,Indentation = new Thickness(5,0,0,0),TextColor = (Color)App.Current.Resources["TextGrayColor"]},
                    new MenuPageMenuItem { Id = 3, Title = "List of Rounds" ,TargetType = typeof(RoundListPage),Icon = "listofteams.png",IsUnderlined = false,Indentation = new Thickness(5,0,0,0),TextColor = (Color)App.Current.Resources["BlackColor"]},
                    new MenuPageMenuItem { Id = 4, Title = "Round Rules" ,TargetType = typeof(ListofRulesPage),Icon = "listofteams.png",IsUnderlined = true,Indentation = new Thickness(5,0,0,0),TextColor = (Color)App.Current.Resources["BlackColor"]},
                    ...
                    new MenuPageMenuItem { Id = 11, Title = "Logout" ,Icon = "logout.png",TargetType = typeof(LoginPage),IsUnderlined = false,Indentation = new Thickness(5,0,0,0),TextColor = (Color)App.Current.Resources["BlackColor"]}
                    });
                }
            }
